Funkce je prvek v SQL který umožnuje spouštět část kódu, přijímat vstup od uživatele, a vracet proměnnou podle našich potřeb 
- neumí provádět komplikovanější operace 
- používá se spíše pro výpočet abychom nemuseli psát vzorečky v dotazech furt dokola.
